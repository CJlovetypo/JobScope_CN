...
import {repository, dataset, readJSON, parseCSV, inspectURL, hash} from '../history.mjs';
...
const mappings = {
  ...
  'waiqi-candidates.json':'catalog/waiqi-source-candidates.json',
  'waiqi-interfaces.json':'catalog/waiqi-interface-catalog.json',
