...
const broadProviders=new Set(['51job_coapi','51job_xyz','zhaopin_grace','workday','smartrecruiters','oracle_recruiting','nowcoder_public','greenhouse','microsoft_eightfold','sap_rss','amazon_jobs','xinrenxinshi','yotta','tongcheng','wenhua_public']);
