...
const bars=top.map((t,i)=>{const y=238+39*i,w=Math.round(570*t.count/top[0].count);return `<text x="58" y="${y+19}" class="label">${t.label}</text><rect x="360" y="${y}" width="${w}" height="24" rx="5" fill="#168ba1"/><text x="${372+w}" y="${y+18}" class="value">${t.count}</text>`;}).join('');
const svg=`<svg xmlns="http://www.w3.org/2000/svg" width="1152" height="720" viewBox="0 0 1152 720" role="img" aria-labelledby="title desc"><title id="title">${title}</title><desc id="desc">展示覆盖主体数最多的十个行业。</desc><style>.title{font:700 32px 'Microsoft YaHei','Noto Sans CJK SC',sans-serif;fill:#14213d}.sub{font:18px 'Microsoft YaHei',sans-serif;fill:#526173}.metric{font:700 38px 'Segoe UI','Microsoft YaHei',sans-serif;fill:#087f8c}.metricLabel{font:15px 'Microsoft YaHei',sans-serif;fill:#526173}.label{font:17px 'Microsoft YaHei',sans-serif;fill:#243247}.value{font:700 16px 'Segoe UI',sans-serif;fill:#087f8c}</style><rect width="1152" height="720" fill="#f6f8fb"/><text x="58" y="62" class="title">招聘来源覆盖</text><text x="58" y="94" class="sub">公开招聘接口与招聘主体的当前维护规模</text><text x="58" y="160" class="metric">${number(companies)}</text><text x="58" y="188" class="metricLabel">公司／招聘主体</text><text x="286" y="160" class="metric">${number(configurations)}</text><text x="286" y="188" class="metricLabel">招聘接口配置</text><text x="514" y="160" class="metric">${INDUSTRIES.length}</text><text x="514" y="188" class="metricLabel">行业大类</text><text x="58" y="224" class="sub">覆盖主体数最多的十个行业</text>${bars}<text x="58" y="684" class="sub">统计于 ${date} · 同一主体可属于多个行业</text></svg>\n`;
