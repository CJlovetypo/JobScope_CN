...
const evidenceFields = ['ability', 'ability_reason', 'experience_relevance', 'interest', 'interest_checks', 'interest_reason', 'eligibility', 'eligibility_reason', 'conclusion', 'comparisons', 'transferable_evidence', 'gaps', 'early_internship', 'next_step', 'next_action', 'report_summary', 'review_method'];
